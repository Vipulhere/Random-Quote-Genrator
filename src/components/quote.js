...
let textColors=["red","black","blue","purple","darkMagenta", "rgb(08,2004,72)", 'darkGreen', 'brown', 'orange', 'violet', 'indigo', 'darkTurquoise']
...
class Quotes extends React.Component {
    ...
    render(){
        ...
        return (
            <div style={styles}>
                <div style={styles.p}>
                <p><sup><i class="fas fa-quote-left"></i></sup> {this.state.message}</p>
                <p style={styles.name}>-{this.state.author}</p>
                <div style={styles.button}>
                <TwitterApi message={this.state.message} author={this.state.author} styling={styles.tweet.color}/>
                <button onClick={this.handleClick}  style={styles.btn} className='btn'>New Quote</button>
                </div>
                </div>
            </div>
        )
